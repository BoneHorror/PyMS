...
def check_compat(program_name, additional_requirements=Requirement.none): # type: (str, int) -> None
	...
	if sys.version_info.major == 2 and sys.version_info.minor != 7:
		DependencyError(program_name, 'Incorrect Python 2 version (%d.%d instead of 2.7). Please consult the Installation section of the Readme.' % (sys.version_info.major, sys.version_info.minor), readmes).startup()
		sys.exit()
